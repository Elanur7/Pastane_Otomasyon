...
include ("pastane_baglan.php");
$baklavaıd= $_GET['ıd'];
$sql="SELECT * FROM baklavalar WHERE baklavaıd=".$_GET['ıd'];
...
<body>
<div class="tablo">
<form action="pastanebaklava_guncelle.php?ıd=<?php echo $_GET['ıd']?>"  method="post">
<table border="1" align="center">
<tr>
<td colspan="2" align="center">Baklava Güncelle</td>
</tr>
<tr>
<td>Baklava Adı</td>
<td><input type="text" name="baklavaadi" value="<?php echo $gelen['baklavaadi']?>"></td>
</tr>
<tr>
<td>Baklava Fiyatı</td>
<td><input type="text" name="baklavafiyati" value="<?php echo $gelen['baklavafiyati']?>"></td>
</tr>
<tr>
...
<div class="center">
    ...
    <div class="buttons">
        ...
        <button><a href="baklavaekle.php">Baklava Ekle</button><br><br>
        <button><a href="baklavasilme.php">Baklava Silme</button>
</div>
</div>
</body>
</html>