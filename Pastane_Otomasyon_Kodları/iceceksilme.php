...
<th>İçecek ID</th>
<th>İçecek Adı</th>
<th>İçecek Fiyatı</th></tr>';

while($satir=mysqli_fetch_array($cevap)){
    echo '<tr>';
    echo '<td>'.$satir['icecekıd'].'</td>';
    echo '<td>'.$satir['icecekadi'].'</td>';
    echo '<td>'.$satir['icecekfiyati'].'</td>';
    echo '<td> <a href="pastane_iceceksilme.php?icecekıd='.$satir['icecekıd'].'"onclick="return uyari();">Sil</a></td>';
    echo '</tr>';
}
echo '</table><br><br>';
?>
...
<div class="center">
    ...
    <div class="buttons">
        ...
        <button><a href="icecekekle.php">İçecek Ekleme</button><br><br>
        <button><a href="icecekguncelle.php">İçecek Güncelle</button>
</div>
</div>
</body>
</html>