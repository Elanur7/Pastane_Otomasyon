...
<div class="tablo">
<?php
$sql="SELECT * FROM pastalar";
$cevap=mysqli_query($baglanti,$sql);
echo '<table border=1 bordercolor=black><tr>
<th>Pasta ID</th>
<th>Pasta Adı</th>
<th>Pasta Fiyatı</th></tr>';

while($satir=mysqli_fetch_array($cevap)){
    echo '<tr>';
    echo '<td>'.$satir['pastaıd'].'</td>';
    echo '<td>'.$satir['pastaadi'].'</td>';
    echo '<td>'.$satir['pastafiyati'].'</td>';
    echo '<td> <a href="pastane_pastasilme.php?pastaıd='.$satir['pastaıd'].'"onclick="return uyari();">Sil</a></td>';
    echo '</tr>';
}
echo '</table><br><br>';
?>
...
<div class="center">
    ...
    <div class="buttons">
        ...
        <button><a href="pastaekle.php">Pasta Ekleme</button><br><br>
        <button><a href="pastaguncelle.php">Pasta Güncelle</button>
</div>
</div>
</body>
</html>