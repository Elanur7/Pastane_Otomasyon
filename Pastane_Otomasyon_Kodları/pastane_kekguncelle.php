...
<ul>
    ...
    <li><a href="#" class="active">Kekler</a></li>
...
include ("pastane_baglan.php");
$kekıd= $_GET['ıd'];
$sql="SELECT * FROM kekler WHERE kekıd=".$_GET['ıd'];
...
<body>
<div class="tablo">
<form action="pastanekek_guncelle.php?ıd=<?php echo $_GET['ıd']?>"  method="post">
<table border="1" align="center">
<tr>
<td colspan="2" align="center">Kek Güncelle</td>
</tr>
<tr>
<td>Kek Adı</td>
<td><input type="text" name="kekadi" value="<?php echo $gelen['kekadi']?>"></td>
</tr>
<tr>
<td>Kek Fiyatı</td>
<td><input type="text" name="kekfiyati" value="<?php echo $gelen['kekfiyati']?>"></td>
</tr>
<tr>
...
<div class="center">
    ...
    <div class="buttons">
        <button><a href="keklistele.php">Pasta Listele</button>
        <button><a href="kekekle.php">Pasta Ekle</button><br><br>
        <button><a href="keksilme.php">Pasta Silme</button>
</div>
</div>
</body>
</html>