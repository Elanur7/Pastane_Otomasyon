...
while($satir=mysqli_fetch_array($cevap)){
    echo '<tr>';
    echo '<td>'.$satir['kekıd'].'</td>';
    echo '<td>'.$satir['kekadi'].'</td>';
    echo '<td>'.$satir['kekfiyati'].'</td>';
    echo '<td> <a href="pastane_keksilme.php?kekıd='.$satir['kekıd'].'"onclick="return uyari();">Sil</a></td>';
    echo '</tr>';
}
echo '</table><br><br>';
?>
...
<div class="center">
    ...
    <div class="buttons">
        <button><a href="keklistele.php">Kek Listele</button>
        <button><a href="kekekle.php">Kek Ekleme</button><br><br>
        <button><a href="kekguncelle.php">Kek Güncelle</button>
</div>
</div>
</body>
</html>