...
<body>
<div class="tablo">
<form method="post" action="pastane_baklavaekle.php">
<table border="1" align="center">
<tr>
<td colspan="2" align="center">Baklava Ekleme</td>
</tr>
<tr>
<td>Baklava Adı</td>
<td><input type="text" name="baklavaadi"></td>
</tr>
<tr>
<td>Baklava Fiyatı</td>
<td><input type="text" name="baklavafiyati"></td>
</tr>
<tr>
...
<div class="center">
    ...
    <div class="buttons">
        ...
        <button><a href="baklavasilme.php">Baklava Silme</button><br><br>
        <button><a href="baklavaguncelleme.php">Baklava Güncelle</button>
</div>
</div>
</body>
</html>