...
<div class="tablo">
<?php
$sql="SELECT * FROM börekler";
$cevap=mysqli_query($baglanti,$sql);
echo '<table border=1 bordercolor=black><tr>
<th>Börek ID</th>
<th>Börek Adı</th>
<th>Börek Fiyatı</th></tr>';

while($satir=mysqli_fetch_array($cevap)){
    echo '<tr>';
    echo '<td>'.$satir['börekıd'].'</td>';
    echo '<td>'.$satir['börekadi'].'</td>';
    echo '<td>'.$satir['börekfiyati'].'</td>';
    echo '<td> <a href="pastane_böreksilme.php?börekıd='.$satir['börekıd'].'"onclick="return uyari();">Sil</a></td>';
    echo '</tr>';
}
echo '</table><br><br>';
?>
...
<div class="center">
    ...
    <div class="buttons">
        ...
        <button><a href="börekekle.php">Börek Ekleme</button><br><br>
        <button><a href="börekguncelle.php">Börek Güncelle</button>
</div>
</div>
</body>
</html>