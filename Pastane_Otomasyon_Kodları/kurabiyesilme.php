...
<div class="tablo">
<?php
$sql="SELECT * FROM kurabiyeler";
$cevap=mysqli_query($baglanti,$sql);
echo '<table border=1 bordercolor=black><tr>
<th>Kurabiye ID</th>
<th>Kurabiye Adı</th>
<th>Kurabiye Fiyatı</th></tr>';

while($satir=mysqli_fetch_array($cevap)){
    echo '<tr>';
    echo '<td>'.$satir['kurabiyeıd'].'</td>';
    echo '<td>'.$satir['kurabiyeadi'].'</td>';
    echo '<td>'.$satir['kurabiyefiyati'].'</td>';
    echo '<td> <a href="pastane_kurabiyesilme.php?kurabiyeıd='.$satir['kurabiyeıd'].'"onclick="return uyari();">Sil</a></td>';
    echo '</tr>';
}
echo '</table><br><br>';
?>
...
<div class="center">
    ...
    <div class="buttons">
        ...
        <button><a href="kurabiyeekle.php">kurabiye Ekleme</button><br><br>
        <button><a href="kurabiyeguncelle.php">kurabiye Güncelle</button>
</div>
</div>
</body>
</html>